...
# user scaffold (name, email, password) with devise gem (   gem 'devise' ) and run rails generate devise:install and rails generate devise User and rails db:migrate
# rails generate scaffold User name:string email:string password:string 
# devise gem
# rails generate devise:install
# rails generate devise User
# gen migration to add confirmable to user
# rails generate migration AddConfirmableToDevise
# gen view for devise
...
# scaffold for transaction
rails generate scaffold Transaction name:string amount:integer category:references 
